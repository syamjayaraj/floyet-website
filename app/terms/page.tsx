      ...
      <div className="container py-6">
        ...
        <div className="policy-content reveal fade-in">
          <section className="policy-section">
            ...
            <p>
              By accessing or using Floyet’s websites, applications (including
              GymTie - our flagship product - YoungMenu, DevaPatha, Livonomi,
              and Onebest), and services, you agree to be bound by these Terms
          ...
          <section className="policy-section">
            ...
            <p>
              ...
              platforms-including text, graphics, logos, and code-are the
              exclusive property of Floyet Labs & Technologies LLP and are
          ...
          <section className="policy-section">
            ...
            <p>
              Floyet shall not be liable for any indirect, incidental, special,
