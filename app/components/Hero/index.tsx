...
const Hero = () => {
  return (
    <section className="apple-hero" style={{ background: "transparent", padding: "160px 0 100px", minHeight: "100vh", display: "flex", alignItems: "center", position: "relative" }} id="home">
      <AnimatedBackground />
      <div className="container" style={{ position: "relative", zIndex: 10 }}>
        <div className="apple-hero-content reveal fade-in-up" style={{ textAlign: "center" }}>
          ...
          <h1 className="apple-hero-headline" style={{ fontWeight: 800, fontSize: "clamp(48px, 8vw, 84px)", letterSpacing: "-0.02em", marginBottom: "24px", color: "var(--color-text-primary)" }}>
            Engineered in the lab.<br/> Proven in the <span style={{ color: "var(--color-text-secondary)" }}>real world</span>.
          </h1>
          ...
          <div className="apple-hero-cta" style={{ display: "flex", gap: "16px", justifyContent: "center" }}>
            <a href="#products" className="btn-apple btn-apple-secondary hover-lift" style={{ padding: "12px 28px", fontSize: "15px", borderRadius: "100px", fontWeight: 500, display: "flex", alignItems: "center", gap: "8px" }}>
